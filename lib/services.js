...
const { frecencyForUrl, hasLogin } = require("./defaultServices.js");
...
MediatorPanel.prototype = {
  ...
  _inject: function(win, injectURI) {
...
var activityRegistry = {
  ...
  registerActivityHandler: function(activity, uri, data) {
    ...
    // to auto-enable
    let enabled = hasLogin(loginHost) || frecency > 50;
