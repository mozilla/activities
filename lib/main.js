...
function registerInternalHandler(activityName, url, name, options) {
  let {
    activityRegistry
  } = require("activities/services");
  activityRegistry.registerActivityHandler(activityName, url, name, {
    origin: this.origin,
...
registerInternalHandler("share", "https://www.facebook.com/sharer/sharer.php", "Facebook", {
  origin: "https://www.facebook.com/",
  launch_url: "https://www.facebook.com/sharer/sharer.php",
  manifest: {
    "icons": {
      "16": "https://www.facebook.com/favicon.ico"
    }
  }
});
registerInternalHandler("share", "http://digg.com/submit", "Digg", {
  origin: "http://digg.com/",
  launch_url: "http://digg.com/submit",
  manifest: {
    "icons": {
      "16": "http://digg.com/favicon.ico"
    }
  }
});
registerInternalHandler("share", "https://mail.google.com/mail/?view=cm&ui=2&tf=0&fs=1", "Gmail", {
  origin: "https://mail.google.com/",
  launch_url: "https://mail.google.com/mail/?view=cm&ui=2&tf=0&fs=1",
  manifest: {
    "icons": {
      "16": "https://mail.google.com/favicon.ico"
    }
  }
});
registerInternalHandler("share", "https://twitter.com/intent/tweet", "Twitter", {
  origin: "https://twitter.com/",
  launch_url: "https://twitter.com/intent/tweet",
  manifest: {
    "icons": {
      "16": "https://www.twitter.com/favicon.ico"
    }
  }
});
registerInternalHandler("share", "https://plus.google.com/app/plus/x/?v=compose", "Facebook", {
  origin: "https://plus.google.com/",
  launch_url: "https://plus.google.com/app/plus/x/?v=compose",
  manifest: {
    "icons": {
      "16": "https://plus.google.com/favicon.ico"
    }
  }
});
